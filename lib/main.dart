...
void main() async {
  ...
  //registerAdapters();
  //await Hive.openBox<HiveOpenWeatherModel>('EventsBox');
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context)=>AllEventsCubit(ApiService(),),),
        BlocProvider(create: (context)=>SearchEventsCubit(ApiService(),),),
      ],
      child: MaterialApp(
