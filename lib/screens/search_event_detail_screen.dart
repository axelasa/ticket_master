...
class SearchEventsDetailScreen extends StatefulWidget {
  ...
  final String limit;
  const SearchEventsDetailScreen({super.key, required this.imageUrl, required this.name, required this.date, required this.ticketLink, required this.location, required this.promoter, required this.limit});

  @override
  State<SearchEventsDetailScreen> createState() => _SearchEventsDetailScreenState();
}

class _SearchEventsDetailScreenState extends State<SearchEventsDetailScreen> {
  @override
